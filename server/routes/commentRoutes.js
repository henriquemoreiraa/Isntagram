...
const { createComment, updateComment, deleteComment, likeComment, answerComment, likeAnswer, updateAnswer, deleteAnswer, removelikeComment } = require('../controllers/commentController');

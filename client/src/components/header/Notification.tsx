...
function Notification() {
  ...
  return (
    <div>
      <div onClick={removeNewNotification} className="testew">
        <IoNotificationsOutline size={"1.8em"} className="notificationsvg" />
        {newNotification && (
          <BsDot className="dotnot" color="#f76363" size={"1.5em"} />
        )}
      </div>
      {notification && (
        <div className="notificationDiv">
          <div className="userImg-name2">
            <div className="divImg1">
              <img
                src={`${process.env.REACT_APP_API_URL}${notification?.userImg}`}
                alt=""
              />
            </div>
            <p>
